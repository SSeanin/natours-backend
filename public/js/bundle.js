    ...
    Focm: [
      function(require, module, exports) {
        ...
        function o(e, r, s, o, u, t, i) {
          ...
          c.done ? r(m) : Promise.resolve(m).then(o, u);
        }
        function u(e) {
          return function() {
            var r = this,
        ...
        if (t) {
          var l = JSON.parse(document.getElementById('map').dataset.locations);
          (0, e.displayMap)(l);
        }
        i &&
          ...
          c && c.addEventListener('click', r.logout),
          m &&
            m.addEventListener('submit', function(e) {
              ...
              r.append('name', document.getElementById('name').value),
                ...
                console.log(r),
                (0, s.updateSettings)({ form: r }, 'data');
            }),
          d &&
            d.addEventListener(
              'submit',
